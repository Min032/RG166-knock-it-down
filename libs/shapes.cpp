...
initGlobalIndicator ()
{
	...
	std::fill (std::begin (already_collided_before),
						 std::end (already_collided_before),
						 false);
...
generateObjects ()
{
	...
	if (!already_collided_before[0]
			&& isCollision (character_z_param, 20 - floor_param, objects_z[0]))
		{
	...
	if (!already_collided_before[1]
			&& isCollision (character_z_param, 35 - floor_param, objects_z[1]))
		{
	...
	if (!already_collided_before[2]
			&& isCollision (character_z_param, 50 - floor_param, objects_z[2]))
		{
	...
	if (!already_collided_before[3]
			&& isCollision (character_z_param, 65 - floor_param, objects_z[3]))
		{
	...
	if (!already_collided_before[4]
			&& isCollision (character_z_param, 80 - floor_param, objects_z[4]))
		{
	...
	if (!already_collided_before[5]
			&& isCollision (character_z_param, 95 - floor_param, objects_z[5]))
		{
	...
	if (!already_collided_before[6]
			&& isCollision (character_z_param, 110 - floor_param, objects_z[6]))
		{
	...
	if (!already_collided_before[7]
			&& isCollision (character_z_param, 125 - floor_param, objects_z[7]))
		{
	...
	if (!already_collided_before[8]
			&& isCollision (character_z_param, 140 - floor_param, objects_z[8]))
		{
	...
	if (!already_collided_before[9]
			&& isCollision (character_z_param, 155 - floor_param, objects_z[9]))
		{
	...
	if (!already_collided_before[10]
			&& isCollision (character_z_param, 170 - floor_param, objects_z[10]))
		{
	...
	if (!already_collided_before[11]
			&& isCollision (character_z_param, 185 - floor_param, objects_z[11]))
		{
	...
	if (!already_collided_before[12]
			&& isCollision (character_z_param, 200 - floor_param, objects_z[12]))
		{
	...
	if (!already_collided_before[13]
			&& isCollision (character_z_param, 215 - floor_param, objects_z[13]))
		{
	...
	if (!already_collided_before[14]
			&& isCollision (character_z_param, 230 - floor_param, objects_z[14]))
		{
